...
from fear_ladder.data.repositories.sqlite.events import SQLiteEventRepository
from fear_ladder.data.repositories.sqlite.indicators import SQLiteIndicatorRepository
from fear_ladder.data.repositories.sqlite.observations import (
    SQLiteMarketObservationRepository,
)
from fear_ladder.data.repositories.sqlite.states import SQLiteMarketStateRepository
from fear_ladder.data.repositories.sqlite.strategies import SQLiteStrategyRepository
...
def create_database(db_path: Path | str | None = None) -> Path:
    ...
    try:
        ...
        connection.close()
    from fear_ladder import paths as _paths
